...
export const creamLight: Theme = {
  widget: {
    width: 350, background: '#F4EFE3', overflow: 'hidden',
    color: '#1a1815', fontSize: 12,
    fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, system-ui, sans-serif',
  },
  header: { display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px 6px' },
  title: { flex: 1, fontSize: 14, fontWeight: 600, color: '#1a1815', letterSpacing: '-0.01em' },
  updated: { fontSize: 10, color: '#8a8470', fontFamily: 'JetBrains Mono, monospace' },
  hero: { padding: '4px 16px 10px' },
  heroLabel: { fontSize: 10, color: '#8a8470', letterSpacing: '0.05em', marginBottom: 2, textTransform: 'uppercase' },
  heroValueRow: { display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 2 },
  heroValue: {
    fontFamily: 'JetBrains Mono, monospace', fontSize: 32, fontWeight: 600,
    color: '#1a1815', letterSpacing: '-0.03em', lineHeight: 1,
  },
  heroSub: { fontFamily: 'JetBrains Mono, monospace', fontSize: 11, color: '#8a8470' },
  sparkline: { marginTop: 6 },
  sparkGradOpacity: [0.22, 0],
  pills: { display: 'flex', gap: 6, padding: '0 16px 10px' },
  pill: {
    flex: 1, background: '#FBF7EA', borderRadius: 8, padding: '7px 10px',
    display: 'flex', flexDirection: 'column', gap: 1,
    border: '1px solid #EFE5C8',
  },
  pillLabel: { fontSize: 9, color: '#8a8470', textTransform: 'uppercase', letterSpacing: '0.05em' },
  pillValue: { fontFamily: 'JetBrains Mono, monospace', fontSize: 14, fontWeight: 600, color: '#1a1815' },
  hr: { height: 1, background: '#E5DDC8', margin: '0 16px' },
  section: { padding: '10px 16px' },
  sectionTitle: { fontSize: 9, color: '#8a8470', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 6 },
  providerRow: { marginBottom: 7 },
  providerInfo: { display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 },
  providerDot: { width: 5, height: 5, borderRadius: '50%' },
  providerName: { flex: 1, fontSize: 11, color: '#1a1815' },
  providerCost: { fontFamily: 'JetBrains Mono, monospace', fontSize: 11, color: '#1a1815' },
  barTrack: { height: 2, background: '#E5DDC8', borderRadius: 2, overflow: 'hidden' },
  barFill: { height: '100%', borderRadius: 2, transition: 'width .4s ease' },
  req: { display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0' },
  reqTime: { width: 28, fontSize: 10, color: '#8a8470', fontFamily: 'JetBrains Mono, monospace' },
  reqDot: { width: 5, height: 5, borderRadius: '50%' },
  reqModel: { flex: 1, fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: '#3d362a' },
  reqCost: { fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: '#1a1815' },
  footer: { display: 'flex', gap: 6, padding: '8px 16px 12px', borderTop: '1px solid #E5DDC8' },
  fbtn: {
    flex: 1, background: 'transparent', border: '1px solid #D4C9AC',
    color: '#3d362a', fontSize: 11, padding: '7px 10px', borderRadius: 8,
